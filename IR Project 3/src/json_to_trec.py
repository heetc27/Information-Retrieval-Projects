...
for q in que:
    ...
    inurl = 'http://18.188.221.217:8983/solr/BM25/query?q={}&q.op=OR&defType=dismax&wt=json&qf=text_en%20text_de%20text_ru&fl=id,score&wt=json&indent=true&rows=20'.format(q)
